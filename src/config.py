...
APP_DESCRIPTION = "Explainable financial sentiment and Buy/Hold/Sell signal analysis app."
...
FINBERT_LOCAL_PATH = FINBERT_DIR / "fine_tuned_finbert"
USE_LOCAL_FINBERT = os.getenv("USE_LOCAL_FINBERT", "true").lower() == "true"
...
SELL_THRESHOLD = float(os.getenv("SELL_THRESHOLD", "-0.30"))
...
VOLUME_WEIGHT = 0.10
ADVANCED_INDICATOR_WEIGHT = 0.10
RISK_WEIGHT = 0.10

ML_SIGNAL_WEIGHT = 0.05
...
BACKTEST_BUY_LEVEL = 0.30
BACKTEST_SELL_LEVEL = -0.30
...
STREAMLIT_PAGE_TITLE = "FinSentinel"
STREAMLIT_PAGE_ICON = "📈"
